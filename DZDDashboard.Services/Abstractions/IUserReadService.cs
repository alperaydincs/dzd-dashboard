...
public interface IUserReadService
{
    ...
    Task<EmployeeDto?>            GetEmployeeCardAsync(int id, CancellationToken cancellationToken = default);
    Task<EmployeeDto?>            GetEmployeeCardBySlugAsync(string slug, CancellationToken cancellationToken = default);
